                        ...
                        <div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
                            ...
                            <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="contact_info_content">
                                    ...
                                    <div class="contact_info_text">+88{{ $setting->phone }}</div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="contact_form_container">
                            ...
                            <form action="{{ route('user.contact.store') }}" id="contact_form">
                                @csrf
                                <div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
                                    <input type="text" id="contact_form_name" class="contact_form_name input_field" placeholder="Your name" data-error="Name is required." name="name">
                                    @error('name')
                                    ...
                                    @error('email')
                                        <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                    <input type="number" id="contact_form_phone" class="contact_form_phone input_field" placeholder="Your phone number" name="phone">
                                    @error('phone')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                                <div class="contact_form_text">
                                    <textarea id="contact_form_message" class="text_field contact_form_message" name="message" rows="4" placeholder="Message" required="required" data-error="Please, write us a message."  name="message"></textarea>
                                </div>
