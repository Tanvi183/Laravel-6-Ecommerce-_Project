...
@section('content')
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll"><img src="{{ asset('/public/frontend/images/shop_background.jpg') }}"></div>
		<div class="home_overlay"></div>
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{ $search_keyword }}</h2>
		</div>
	</div>
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
                                @foreach($subcategory as $row)
                                    <li><a href="{{ url('/product/subcategory/'.$row->subcategory_id.'/'.$row->subcategory_name) }}">{{ $row->subcategory_name }}</a></li>
                                @endforeach
							</ul>
                        </div>
				...
				<div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span>{{ $search_products->count() }}</span> products found</div>
                            ...
                            @foreach ($search_products as $item)
                                <div class="product_item is_new">
                                    ...
                                    <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                        <img src="{{ asset('/public/backend/media/product/'. $item->image_one) }}" alt="Product image" style="height: 120px; width: 100px;">
                                    </div>
