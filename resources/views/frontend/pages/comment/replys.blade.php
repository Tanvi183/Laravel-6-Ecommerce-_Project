        ...
        <div class="display-comment">
            <div class="row" style="margin-top: 2%;">
                <div class="image_area" style="margin: 3px 10px 0px 17px;">
                    <img src=" @if (isset($comment->user->image)){{ asset('/public/users/'. $comment->user->image) }}
                        @else {{ asset('/public/frontend/images/adv_1.png') }} @endif" alt="" style="width: 45px; margin: 0 auto; border-radius: 50%; border: 2px solid #ddd;">
                </div>
