		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="{{ asset('/public/backend/media/product/' .$product->image_one) }}"><img src="{{ asset('/public/backend/media/product/' .$product->image_one) }}" alt=""></li>

						<li data-image="{{ asset('/public/backend/media/product/' .$product->image_two) }}">
							<img src="@if(isset($product->image_two)){{ asset('/public/backend/media/product/' .$product->image_two) }} 
								@else{{ asset('/public/frontend/img/image_not_available_icon.png') }} @endif" alt="Product Image">
						</li>
						<li data-image="{{ asset('/public/backend/media/product/' .$product->image_three) }}">
							<img src="@if(isset($product->image_three)){{ asset('/public/backend/media/product/' .$product->image_three) }} 
								@else{{ asset('/public/frontend/img/image_not_available_icon.png') }} @endif" alt="Product Image">
						</li>
					</ul>
				</div>
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="{{ asset('/public/backend/media/product/' .$product->image_one) }}" alt=""></div>
				</div>
	...
	<div class="product-details" style="background: #eff6fa; padding-top: 20px;">
		<div class="container">
			...
			<div class="tab-content" id="nav-tabContent">
				...
				<div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">Comment box</div>
			</div><br>
		</div>
	</div>
