    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
         <div class="card pd-20 pd-sm-40">
          ...
          <p class="mg-b-20 mg-sm-b-30">New Post Add Form <a href="{{ route('admin.blogPost.index') }}" class="btn btn-success pd-x-20 pull-right">All Post</a>
          </p>
            ...
            <div class="form-layout">
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input class="form-control" type="text" name="post_title_en" id="post_title_en" placeholder="Enter Post Title English">
                        </div>
                        <!--- Error Message -->
                        @error('post_title_en')
                    ...
                    <div class="col-lg-6">
                        ...
                        <img style="height: 250px; width: 550px; margin-bottom: 5px;" src="{{ asset('public/backend/use/800px-Insert_image_here.svg.png') }}" id="image1" alt="Main Image">
                        <!--- Error Message -->
                        @error('image')
                            <strong style="color: red;">{{ $message }}</strong>
                        @enderror
