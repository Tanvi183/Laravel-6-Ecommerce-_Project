            ...
            <div class="form-layout">
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img width="100" height="100" src="{{ asset('public/backend/media/product/'.$productShow->image_one) }}" alt="">
                        </div>
                    </div><!-- col-4 -->
                     <div class="col-lg-4">
                        <div class="form-group">
                        ...
                        <img width="100" height="100" src="{{ asset('public/backend/media/product/'.$productShow->image_two) }}" alt="">
                        </div>
                    </div><!-- col-4 -->
                     <div class="col-lg-4">
                        <div class="form-group">
                        ...
                        <img width="100" height="100" src="{{ asset('public/backend/media/product/'.$productShow->image_three) }}" alt="">
                        </div>
                    </div><!-- col-4 -->
                </div><!-- row -->
                <br><hr>
