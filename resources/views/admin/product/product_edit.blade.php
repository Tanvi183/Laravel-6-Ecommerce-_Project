...
@section('admin_content')
            ...
            <div class="form-layout">
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img style="height: 250px; width: 250px; margin-bottom: 15px;" src="{{ asset('public/backend/media/product/'.$productShow->image_one) }}" id="image1" alt="Main Image">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img style="height: 250px; width: 250px; margin-bottom: 15px;" src="{{ asset('public/backend/media/product/'.$productShow->image_two) }}" id="image2" alt="2nd Image">
                        <label class="custom-file">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img style="height: 250px; width: 250px; margin-bottom: 15px;" src="{{ asset('public/backend/media/product/'.$productShow->image_three) }}" id="image3" alt="Main Image">
                        <label class="custom-file">
    ...
    <!----- Link For Ajax ----->
<script src="{{ asset('public/backend/lib/ajax/jquery.min.js') }}"></script>
<!--- Link For Taginput --->
<script src="{{ asset('public/backend/lib/taginput/jquery-2.2.4.min.js') }}"></script>
<script src="{{ asset('public/backend/lib/taginput/bootstrap-tagsinput.min.js') }}"></script>
