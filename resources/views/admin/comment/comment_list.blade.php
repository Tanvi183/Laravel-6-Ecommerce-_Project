...
@section('admin_content')
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Product Comments</span>
      </nav>

      <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Comment LIST
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">Comment Product</th>
                  <th class="wd-10p">Parent Comment</th>
                  <th class="wd-10p">Comment Time</th>
