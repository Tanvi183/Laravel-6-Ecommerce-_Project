      ...
      <nav class="nav">
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <img src="@if(isset(Auth::user()->image)){{ asset('/public/backend/profile/'. Auth::user()->image) }}
                      @else{{ asset('public/backend/img/img3.jpg') }} @endif " class="wd-32 rounded-circle" alt="">
          </a>
