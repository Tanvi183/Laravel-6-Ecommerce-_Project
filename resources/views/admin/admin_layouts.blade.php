...
<html lang="en">
  <head>
    ...
    <!-- toastr CSS -->
    <link href="{{ asset('public/backend/lib/toastr/toastr.css') }}" rel="stylesheet">
    <!-- dataTables CSS -->
    ...
    <!-- sweetaleart CSS -->
    <link href="{{ asset('public/backend/lib/sweetalert2/dist/sweetalert2.min.css') }}" rel="stylesheet">
    <!-- summernote CSS -->
    <link href="{{ asset('public/backend/lib//summernote/summernote-bs4.css') }}" rel="stylesheet">
    <!-- tagsinput CSS -->
    <link href="{{ asset('public/backend/lib/taginput/bootstrap-tagsinput.css') }}" rel="stylesheet">
    <!-- Starlight CSS -->
